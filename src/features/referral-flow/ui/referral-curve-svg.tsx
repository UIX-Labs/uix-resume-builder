...
export function CurveUpwardsSvg({ className, stroke = 'rgba(255,255,255,0.4)', ...props }: CurveSvgProps) {
  return (
...
export function CurveDownwardsSvg({ className, stroke = 'rgba(255,255,255,0.4)', ...props }: CurveSvgProps) {
  return (
    <svg className={className} viewBox="0 0 260 80" fill="none" {...props}>
