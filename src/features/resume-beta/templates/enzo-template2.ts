// ---------------------------------------------------------------------------
// Kate Modern Professional — typed DSL version
//
// Migrated from src/features/resume/templates/enzo-template2.ts
// Banner header, 50/50 two-column body, blue accent headings.
// ---------------------------------------------------------------------------
...
const enzoTemplate2: TypedTemplateConfig = {
  ...
  sections: [
    ...
    // ── Experience — Left Column ────────────────────────────────────────
    {
      ...
      itemTemplate: {
        ...
        rows: [
          {
            cells: [{ path: itemField('experience', 'position'), className: 'text-xs font-bold pt-4' }],
          },
          {
    ...
    // ── Education — Right Column ────────────────────────────────────────
    {
      ...
      itemTemplate: {
        ...
        rows: [
          { cells: [{ path: itemField('education', 'degree'), className: 'text-xs font-bold' }] },
    ...
    // ── Projects — Right Column ─────────────────────────────────────────
    {
      ...
      itemTemplate: {
        ...
        rows: [
          {
            cells: [
              { path: itemField('projects', 'title'), fallback: 'Project Title', className: 'text-xs font-bold' },
            ],
          },
          {
