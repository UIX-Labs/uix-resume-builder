...
export function renderContentSection(
  ...
  if (isSummarySection) {
    ...
    const personalDetailsSuggestions =
      data["personalDetails"]?.suggestedUpdates;
    hasValidSuggestions =
      hasPendingSuggestions(professionalSummarySuggestions) ||
      hasPendingSuggestions(personalDetailsSuggestions);
  } else {
