const enzoTemplate3 = {
  ...
  sections: [
    // Header Section with Name, Title, Description and Contact Info
    {
      ...
      className: 'flex flex-row justify-between gap-8 mb-3 pb-3 bg-[#E4F6FB80] p-6',
      leftColumn: {
        className: 'min-w-0',
        sections: [
          {
              ...
              sections: [
                {
                  ...
                  fields: {
                    ...
                    title: {
                      ...
                      className: 'text-base text-[#1C8EB5] font-normal',
                    },
                  },
                },
              ],
        ...
        sections: [
          // Work Experience Section
          {
            ...
            heading: {
              ...
              className: 'text-base font-semibold text-[#1C8EB5] mb-2',
            },
