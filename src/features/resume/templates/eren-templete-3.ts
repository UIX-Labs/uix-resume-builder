  ...
  sections: [
     ...
     */
    {
      ...
      fields: {
        name: {
          ...
          className:
            "text-[30px] font-bold tracking-tight text-neutral-900 leading-none",
        },
        title: {
        ...
        contact: {
          ...
          type: "contact-grid",
          className:
            "flex flex-row flex-wrap items-center gap-4 text-[10px] text-neutral-700 mt-2",
          separator: " • ",
          items: [
            {
     ...
     */
    {
      ...
      heading: {
        ...
        fallback: "SUMMARY",
        className:
          "text-base font-semibold uppercase tracking-wide border-b-4 border-black pb-2",
      },
      content: {
        type: "html",
        ...
        fields: [
          {
            type: "inline-group",
            className:
              "flex flex-col gap-1 text-[11px] font-semibold text-neutral-900",
            items: [
              {
                path: "position",
          ...
          },
          {
            ...
            separator: " • ",
            className:
              "flex flex-wrap items-center gap-2 text-[10px] text-neutral-600",
            items: [
              {
                type: "duration",
                path: "duration",
      ...
      itemTemplate: {
        ...
        fields: [
          ...
          },
          {
            ...
            separator: " • ",
            className:
              "flex flex-wrap items-center gap-1 text-[10px] text-neutral-600",
            items: [
              {
                type: "duration",
                path: "duration",
     ...
     */
    {
      ...
      heading: {
        ...
        fallback: "INTERESTS",
        className:
          "text-base font-semibold uppercase tracking-wide border-b-4 border-black pb-2 pt-1",
      },
