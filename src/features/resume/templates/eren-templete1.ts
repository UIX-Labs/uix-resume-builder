...
const enjiTemplate = {
	...
	sections: [
		 ...
		 */
		{
			...
			type: 'header',
			className:
				'flex flex-col items-center text-center gap-1 pb-6 pt-8 bg-no-repeat bg-cover bg-center',
			style: {
				backgroundImage: "url('/images/eren-templete-header.svg')",
			...
			fields: {
				...
				title: {
					...
					className:
						'text-[10px] font-medium text-slate-600 leading-none tracking-normal',
				},
				contact: {
					type: 'inline-group',
							...
							items: [
								{
									...
									badgeClassName:
										'bg-[#F6F3FF] text-purple-900 border border-[#7C3AED]',
								},
								{
									type: 'badge',
									pathWithFallback: {
									...
									badgeClassName:
										'bg-[#F1F8FF] text-blue-900 border border-[#0A66C2]',
								},
								{
									type: 'badge',
									pathWithFallback: {
									...
									badgeClassName:
										'bg-[#FFF4F1] text-orange-900 border border-[#F24E1E]',
								},
								{
									type: 'badge',
									pathWithFallback: {
									...
									badgeClassName:
										'bg-[#F2F2F2] text-gray-900 border border-[#222222]',
								},
							],
						},
					],
		...
		/**
		 * CONTENT WRAPPER
		 * Wraps all content sections with proper padding
		 */
		{
			id: 'content-wrapper',
			...
			sections: [
				 ...
				 */
				{
					...
					heading: {
						...
						fallback: 'Education',
						className:
							'text-[10px] font-semibold tracking-wide text-slate-500 uppercase w-32',
					},
					...
					className: "flex justify-between items-start gap-8 pb-4 border-b border-slate-200",
				 ...
				 */
				{
					...
					className: "flex justify-between items-start gap-8 pt-6 pb-4 border-b border-slate-200",
					containerClassName: "space-y-3"
				},
