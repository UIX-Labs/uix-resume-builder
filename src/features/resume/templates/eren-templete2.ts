...
const laurenChenTemplate = {
    ...
    sections: [
        /**
         * TWO-COLUMN LAYOUT
         * Left: Orange sidebar with contact and summary
         * Right: White area with experience, education, skills
         */
        {
            ...
            leftColumn: {
                className: 'w-[272px] bg-[#D58D40] text-white p-8 flex flex-col gap-6',
                sections: [
                    /**
                                        ...
                                        items: [
                                            {
                                                ...
                                                children: [
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        fallback: 'Digital Marketing Specialist with 6+ years of experience in online marketing, branding, and business strategy across music, media, and entertainment industries.',
            ...
            rightColumn: {
                className: 'flex-1 p-8 bg-white flex flex-col gap-5',
                sections: [
                    /**
                        ...
                        itemTemplate: {
                            ...
                            fields: [
                                ...
                                },
                                {
                                    type: 'html',
                                    path: 'description',
                                    className: 'text-xs text-neutral-700 leading-relaxed mt-2 [&_ul]:ml-4 [&_li]:list-disc [&_li]:mb-1 whitespace-pre-wrap',
                                },
                            ],
                        },
