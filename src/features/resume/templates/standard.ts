  ...
  sections: [
    // Header Section
    {
      ...
      fields: {
        name: {
          ...
          fallback: "Your Name",
          className:
            "tracking-wide text-xl uppercase font-extrabold text-black",
        },
        title: {
        ...
        contact: {
          type: "inline-group",
          className:
            "flex flex-row flex-wrap justify-center gap-0.5 mt-1 text-xs text-black",
          separator: " | ",
          items: [
    ...
    // Education Section
    {
      ...
      heading: {
        ...
        fallback: "Education",
        className:
          "uppercase tracking-wide text-sm font-semibold text-black mt-4 gap-1",
        divider: {
          variant: "line",
    ...
    // Summary Section
    {
      ...
      content: {
        ...
        fallback: "Summary",
        className:
          "text-xs text-neutral-800 text-justify whitespace-pre-wrap mt-3",
      },
    },
    // Experience Section
    {
      ...
      heading: {
        ...
        fallback: "Experience",
        className:
          "uppercase tracking-wide text-sm font-semibold text-black gap-1 mt-4 mb-2",
      ...
      itemTemplate: {
        ...
        rows: [
          {
            className:
              "flex flex-row justify-between items-center text-sm text-black mb-1",
            cells: [
              {
                type: "inline-group",
                separator: " | ",
...

    {
      ...
      heading: {
        ...
        fallback: "Skills",
        className:
          "uppercase tracking-wide text-sm font-semibold text-black mt-4 gap-1 mb-1",
        divider: {
          variant: "line",
          className: "bg-black w-full h-[1.5px] mt-0.5",
        },
    ...
    // Interests Section (Badge Style)
    {
      ...
      badgeClassName:
        "flex flex-row gap-1 items-center justify-center w-fit px-2 py-0.5 bg-black rounded-md text-xs text-white font-semibold whitespace-wrap ",
    },
