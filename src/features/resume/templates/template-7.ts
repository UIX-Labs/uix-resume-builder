  ...
  sections: [
          ...
          items: [
            {
              ...
              items: [
                { type: 'icon', name: 'Mail', size: 16, className: 'text-[#4178B4]' },
                {
            ...
            },
            {
              ...
              className: 'flex items-center gap-2',
              items: [
                { type: 'icon', name: 'Phone', size: 16, className: 'text-[#4178B4]' },
                { path: 'personalDetails.items[0].phone', fallback: '7042403591', className: 'text-sm text-gray-800' },
              ],
            },
            {
              type: 'inline-group-with-icon',
              className: 'flex items-center gap-2',
              items: [
                { type: 'icon', name: 'MapPin', size: 16, className: 'text-[#4178B4]' },
                {
            ...
            },
            {
              ...
              className: 'flex items-center gap-2',
              items: [
                { type: 'icon', name: 'Linkedin', size: 16, className: 'text-[#4178B4]' },
                {
                  type: 'link',
      ...
      itemTemplate: {
        ...
        rows: [
          ...
          },
          {
            ...
            cells: [
              { type: 'duration', path: 'duration', className: 'text-sm text-gray-500 italic' },
    ...
    // Certifications Section
    {
      ...
      itemTemplate: {
        className: 'flex flex-col',
        fields: [
          { path: 'title', fallback: 'Certification Title', className: 'text-base font-medium text-gray-900' },
          { path: 'issuer', fallback: 'Issuer', className: 'text-sm text-gray-700' },
          { type: 'duration', path: 'duration', className: 'text-sm text-gray-500 italic' },
        ],
      },
    },
