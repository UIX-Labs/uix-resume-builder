            ...
            cells: [
              {
                ...
                items: [
                  ...
                  { type: 'duration', path: 'duration', className: 'font-semibold' },
                ],
              },
            ],
          },
            ...
            cells: [
              {
                ...
                items: [
                  ...
                  { path: 'location', fallback: '', className: 'font-semibold' },
    ...
    // Certifications Section
    {
      ...
      itemTemplate: {
        ...
        fields: [
          ...
          { type: 'duration', path: 'duration', className: 'text-sm text-neutral-600 italic' },
          {
            type: 'link',
            path: 'link.title',
            href: 'link.link',
