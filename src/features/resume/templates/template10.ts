  ...
  sections: [
    // Header Section - Name and Title on one line
    {
      ...
      fields: {
        ...
        name: {
          ...
          fallback: "Nina Patel",
          className:
            "text-[24px] font-bold text-white leading-[1.2] after:text-white whitespace-nowrap",
        },
        title: {
        ...
        contact: {
          ...
          items: [
            ...
            },
            {
              ...
              fallback: "",
              className:
                "text-sm font-medium text-white leading-[1.21] hover:underline",
            },
            {
              type: "link",
...

    {
      ...
      heading: {
        ...
        fallback: "Skills",
        className:
          "text-base font-bold text-white uppercase tracking-normal mb-3 leading-[1.21]",
      },
    ...
    // Work Experience Section - Left Column
    {
      ...
      heading: {
        ...
        className:
          "text-base font-bold text-white tracking-normal uppercase leading-[1.21] mb-3",
      },
            ...
            cells: [
              {
                ...
                items: [
                  ...
                  },
                  {
                    ...
                    className:
                      "text-sm font-normal text-[#D1D5DB] leading-[1.21]",
                  },
                ],
              },
              {
                ...
                path: "duration",
                className:
                  "text-[10px] uppercase tracking-[0.02em] italic text-[#9CA3AF] leading-[1.21]",
              },
            ],
          },
          {
    ...
    // Education Section - Left Column
    {
      ...
      heading: {
        ...
        fallback: "Education",
        className:
          "text-base font-bold text-white tracking-normal uppercase leading-[1.21] mt-2",
      },
        ...
        rows: [
          {
            ...
            cells: [
                ...
                items: [
                  {
                    ...
                    className:
                      "text-base font-semibold text-white leading-[1.21]",
                  },
                  {
                    path: "degree",
                    fallback: "BSc(HCI)",
              ...
              },
              {
                ...
                path: "duration",
                className:
                  "text-[10px] italic uppercase tracking-[0.02em] text-[#9CA3AF] leading-[1.21]",
              },
            ],
          },
          {
    ...
    // Certifications Section - Left Column
    {
      ...
      heading: {
        ...
        className:
          "text-base font-bold text-white tracking-normal uppercase leading-[1.21] mt-4",
      },
    ...
    // Interests Section - Right Column
    {
      ...
      heading: {
        ...
        fallback: "Interests",
        className:
          "text-base font-bold text-white uppercase tracking-normal mb-3 leading-[1.21] mt-5",
      },
