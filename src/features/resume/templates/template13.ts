  ...
  sections: [
    // Header Section
    {
      ...
      fields: {
        ...
        name: {
          ...
          className:
            'text-4xl font-normal text-[#2C5F5F] after:content-[","] after:mr-2 whitespace-nowrap',
        },
        ...
        contact: {
          type: "inline-group",
          className:
            "text-sm text-[#2C5F5F] flex flex-row flex-wrap gap-2 mb-1",
          separator: "• ",
          items: [
            {
    ...
    // Summary Section
    {
      ...
      content: {
        ...
        className:
          "text-sm text-[#2C5F5F] leading-relaxed text-justify whitespace-pre-wrap",
      },
    },
    ...
    // Key Skills Section
    {
      ...
      heading: {
        ...
        fallback: "Key Skills",
        className:
          "text-[#2C5F5F] text-2xl font-normal mb-1 border-t-2 border-dotted border-[#1a3c34] pt-6 mt-6",
      },
    ...
    // Interests Section
    {
      ...
      heading: {
        ...
        fallback: "Interests",
        className:
          "text-[#2C5F5F] text-2xl font-normal border-t-2 border-dotted border-[#1a3c34] pt-6 mt-6",
      },
      divider: {
        variant: "line",
        className: "border-t-2 border-dotted border-[#1a3c34] w-full mt-1 mb-3",
