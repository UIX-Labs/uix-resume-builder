            ...
            presentation: [
              {
                ...
                className: 'text-sm text-neutral-700 [&_ul]:ml-4 [&_li]:list-disc [&_li]:mb-1 text-justify break-all',
              },
            ],
          },
        ],
                      ...
                      // Right column: Position + Company
                      {
                        ...
                        children: [
                          ...
                          },
                          {
                            ...
                            className: 'text-sm text-gray-700 leading-relaxed break-all [&_ul]:ml-3 [&_li]:list-disc',
                          },
                        ],
                      },
                    ],
