const template6 = {
  ...
  sections: [
    // Header Section with Peach Background (spans full width)
    {
      ...
      type: 'header',
      column: 'right',
      className: 'bg-[#F2936F] px-8 py-20 flex flex-col justify-center gap-4 -mt-8',
      fields: {
        name: {
    ...
    // Skills Section
    {
      ...
      heading: {
        path: 'skills.heading',
        fallback: 'SKILLS',
        className: 'text-[#F2936F] text-base font-extrabold tracking-wider mb-3 mt-8',
      },
    ...
    // Interests Section
    {
      ...
      heading: {
        ...
        fallback: 'INTERESTS',
        className: 'text-[#F2936F] uppercase text-base font-extrabold tracking-wider mb-3 mt-8',
      },
            ...
            },
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  fallback: '',
                  className: 'text-white text-sm font-normal underline break-words mt-1',
                },
              ],
            },
            {
