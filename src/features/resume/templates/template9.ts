    ...
    // Header Section
    {
      ...
      fields: {
        ...
        contact: {
          type: "contact-grid",
          className:
            "flex flex-row flex-wrap items-center gap-4 mt-2 text-sm text-neutral-900 font-bold",
          items: [
            {
            ...
            itemTemplate: {
              ...
              fields: [
                ...
                },
                {
                  ...
                  path: "description",
                  className:
                    "text-sm text-neutral-900 leading-relaxed mt-1 whitespace-pre-wrap",
                },
              ],
            },
          },
              ...
              fields: [
                {
                  ...
                  href: "link.link",
                  className:
                    "text-base font-bold text-neutral-900 mb-1 hover:underline",
                },
                {
                  type: "icon-row",
                  className: "flex flex-row items-center gap-4 mt-1",
      ...
      rightColumn: {
        ...
        sections: [
          // Key Achievements Section
          {
            ...
            icon: "Crown",
            iconClassName:
              "w-5 h-5 text-blue-500 flex-shrink-0 mt-1 fill-blue-500",
          ...
          // Interests Section (Badge Style)
          {
            ...
            badgeClassName:
              "text-sm text-neutral-900 bg-blue-50 px-3 py-1 rounded-full",
          },
