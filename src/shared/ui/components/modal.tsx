      ...
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogPortal>
          ...
          <DialogPrimitive.Content
            ...
            className={cn(
              'bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 grid w-full md:max-w-[calc(100%-16rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border shadow-lg duration-200 outline-none sm:max-w-lg',
          ...
          >
            ...
            {showCloseButton && closeButtonVariant === 'default' && (
              <DialogPrimitive.Close
                ...
                className="ring-offset-background focus:ring-ring data-[state=open]:bg-accent z-100 data-[state=open]:text-muted-foreground absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
              >
                <X className="w-5 h-5" />
