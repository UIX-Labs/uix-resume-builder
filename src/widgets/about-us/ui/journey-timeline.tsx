        ...
        <div className="relative flex flex-col gap-12 max-w-[600px] mx-auto">
          ...
          <div className="relative pl-10 sm:pl-14">
            ...
            <div className="flex items-center gap-3 mb-4">
              <span className="font-serif text-[24px] sm:text-[32px] font-bold text-[#309F66] opacity-80">01</span>
              <span className="font-serif text-[18px] sm:text-[24px] font-bold text-[#309F66] opacity-80">problem</span>
            </div>
            <WhyWeStarted />
          </div>
          ...
          <div className="relative pl-10 sm:pl-14">
            ...
            />
            <div className="flex items-center gap-3 mb-4">
              <span className="font-serif text-[24px] sm:text-[32px] font-bold text-[#57B083] opacity-80">02</span>
            </div>
            <HumanAiApproach />
          </div>
          ...
          <div className="relative pl-10 sm:pl-14">
            ...
            />
            <div className="flex items-center gap-3 mb-4">
              <span className="font-serif text-[24px] sm:text-[32px] font-bold text-[#57B083] opacity-80">03</span>
            </div>
            <TheCommunity />
          </div>
          ...
          <div className="relative pl-10 sm:pl-14">
            ...
            />
            <div className="flex items-center gap-3 mb-4">
              <span className="font-serif text-[24px] sm:text-[32px] font-bold text-[#57B083] opacity-80">04</span>
            </div>
            <SuccessStories />
          </div>
          ...
          <div className="relative pl-10 sm:pl-14">
            ...
            />
            <div className="flex items-center gap-3 mb-4">
              <span className="font-serif text-[24px] sm:text-[32px] font-bold text-[#57B083] opacity-80">05</span>
            </div>
            <VisionSection />
          </div>
        </div>
