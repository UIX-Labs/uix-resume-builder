...
const teamMembers = [
	{
		...
		image:
			'https://uixlabs.co/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FAman.4cefaeb6.png&w=640&q=75',
	...
	},
	{
		...
		image:
			'https://uixlabs.co/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FPhoneix.1e85ac43.jpg&w=640&q=75',
	...
	},
	{
		...
		role: 'Growth Hacker',
		image:
			'https://uixlabs.co/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fvaibhav.5be2c197.jpg&w=640&q=75',
	...
	},
	{
		...
		image:
			'https://uixlabs.co/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FkunalGupta.bda211d5.jpeg&w=640&q=75',
	...
	},
	{
		...
		role: 'UI Engineer, L2',
		image:
			'https://uixlabs.co/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fenzo.a98443ad.jpg&w=640&q=75',
	...
	},
	{
		...
		role: 'UI Engineer, L2',
		image:
			'https://uixlabs.co/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FLoki.1f66544d.jpg&w=640&q=75',
		description: 'Driving technical excellence',
	...
	},
	{
		...
		image:
			'https://uixlabs.co/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FGeoris.ca1cd52e.jpg&w=640&q=75',
		description: 'Driving technical excellence',
	...
	},
	{
		...
		image:
			'https://uixlabs.co/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FDeepanshu.3676d747.jpeg&w=640&q=75',
		description: 'Driving technical excellence',
	...
	},
	{
		...
		role: 'UI Engineer, L1',
		image:
			'https://uixlabs.co/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FTanushiGupta.9f42715b.jpeg&w=640&q=75',
		description: 'Driving technical excellence',
			...
			<div className="flex flex-col lg:flex-row h-full">
				...
				<div className="w-full lg:w-[482px] flex flex-col justify-center py-8 lg:py-0 lg:pl-12 text-center lg:text-left">
					...
					<p className="text-[#666666] text-base md:text-lg leading-[1.33em] tracking-[-0.0144em] max-w-[400px] mx-auto lg:mx-0">
						Meet the people leading the movement to make resumes more human,
						...
						>
							<div className="flex items-center">
								{teamMembers.map((template, index) => {
									...
									const cardWidth = isExpanded ? 'w-[200px] sm:w-[260px] md:w-[324px]' : 'w-[80px] sm:w-[100px] md:w-[125px]';
