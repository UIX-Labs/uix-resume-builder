          ...
          >
            ...
            {step === 'email' && (
              <div className="flex flex-col justify-start gap-4">
                ...
                {errors.email && <div className="text-red-500 text-sm text-start w-[404px]">{errors.email}</div>}
            ...
            {step === 'password' && (
              <div className="flex flex-col justify-start gap-4">
                ...
                {errors.password && <div className="text-red-500 text-sm text-start w-[404px]">{errors.password}</div>}
            ...
            {step === 'code' && (
              <div className="flex flex-col items-center justify-center gap-4 text-sm leading-5 -tracking-[0.02px]">
                {errors.code && <div className="text-red-500 text-sm text-start w-[404px]">{errors.code}</div>}
              ...
              <div className="flex flex-col items-center justify-center gap-6 text-sm leading-5 -tracking-[0.02px]">
                <div className="text-center space-y-4">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-lg font-semibold text-slate-800">Account Found!</h3>
                    ...
                    <p className="text-sm text-neutral-500 mt-4">
                      Please use one of the social login options above to continue.
                    </p>
                  </div>
            ...
            {step === 'register' && (
              <div className="flex flex-col items-center justify-center gap-4 text-sm leading-5 -tracking-[0.02px]">
                {errors.submit && <div className="text-red-500 text-sm text-center w-[404px]">{errors.submit}</div>}
                ...
                {errors.firstName && (
                  <div className="text-red-500 text-xs -mt-2 w-[404px] text-left">{errors.firstName}</div>
                )}
                ...
                {errors.lastName && (
                  <div className="text-red-500 text-xs -mt-2 w-[404px] text-left">{errors.lastName}</div>
                )}
                ...
                {errors.password && (
                  <div className="text-red-500 text-xs -mt-2 w-[404px] text-left">{errors.password}</div>
                )}
                ...
                {errors.confirmPassword && (
                  <div className="text-red-500 text-xs -mt-2 w-[404px] text-left">{errors.confirmPassword}</div>
                )}
