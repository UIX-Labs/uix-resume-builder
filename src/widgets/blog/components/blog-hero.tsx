...
export default function BlogHero({ description, image, children }: BlogHeroProps) {
  return (
   ...
   <div className="relative bg-[url('/images/blog/hero-section/Dot-bg.png')] bg-[#F2F2F233] rounded-2xl sm:p-8 overflow-hidden max-w-[1395px] mx-auto border-4 
border-white h-[296px] md:h-full">
  ...
  <div className="flex flex-col lg:flex-row  justify-between items-center">
    ...
    <div className="w-full lg:w-[55%] relative z-10 px-4 lg:px-10 text-center lg:text-left p-2">
      <h1 className="text-3xl sm:text-4xl lg:text-[63px] font-semibold leading-tight">
        {children}
      </h1>
