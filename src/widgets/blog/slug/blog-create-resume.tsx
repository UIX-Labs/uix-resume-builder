 ...
 items-center gap-4 pr-8 md:gap-2 bg-[url('/images/blog/hero-section/Dot-bg.png')] bg-[#F2F2F233] rounded-2xl border-2 border-green-600 relative overflow-hidden group mt-10 p-2"
      >
        <img
          ...
          alt=""
          className="absolute bottom-0 -left-4  h-20 md:h-40 pointer-events-none select-none"
        />
        <img
          src="/images/blog/slug/avatar-img.png"
          alt=""
          className="absolute bottom-0 -right-4  h-20 md:h-40 pointer-events-none select-none"
        />
