...
export const SuggestionCard = ({
  ...
  <div
    className={`relative p-4 border rounded-lg text-black transition-colors`}
...
export const SuggestionItem = ({
  ...
  const inputId = useId()
  const baseClasses =
    'relative flex w-full items-start gap-3 rounded-lg border border-transparent p-3  cursor-pointer'
