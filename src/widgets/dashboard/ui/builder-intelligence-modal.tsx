...
export default function BuilderIntelligenceModal({
  ...
  const isResumeStepComplete = showResumeUpload
    ? resumeUploadStatus === "success" && !!resumeFile
    : !!resumeFile;
  const isJdStepComplete = showJDUpload ? !!jdFile : true;
  const isActionDisabled =
    isSubmitting || !isResumeStepComplete || !isJdStepComplete;
      ...
      >
        ...
        >
          <div className="flex flex-row gap-6 items-stretch flex-wrap lg:flex-nowrap">
            {showResumeUpload && (
              <ResumeUploadSection
                onFileStatusChange={setResumeUploadStatus}
