  ...
  const cleanValue = value.replace(
    ...
    (_match, beforeStyle, styleContent) => {
      ...
      const cleanedStyle = styleContent
        ...
        .filter(
          (rule: string) =>
            !rule.trim().toLowerCase().startsWith("background-color")
        )
        .join(";");
          ...
          if (typeof item === "object" && item !== null) {
            ...
            Object.keys(cleanItem).forEach((itemKey) => {
              ...
              if (typeof value === "string") {
                ...
                const processedValue = isGeneratingPdf
                  ? removeBackgroundColors(markdownConverted)
                  : markdownConverted;
          ...
          if (typeof mockItem === "object" && mockItem !== null) {
            ...
            if (
              ...
              return {
                ...mockItem,
                itemId:
                  actualItemObj.itemId ||
                  (mockItem as Record<string, unknown>).itemId,
              };
            }
          }
          return mockItem;
