...
const BLOBS: BlobConfig[] = [
  {
    id: 'blue-blob',
    color: '#46A6FF',
    className: 'top-[10%] left-[10%] md:top-[100px] md:left-[257px] size-[12px] md:size-[18px]',
  },
  {
    id: 'yellow-blob',
    color: '#FBC05A',
  ...
  },
  {
    id: 'green-blob',
    color: '#4B7A42',
    className: 'top-[22%] left-[78%] md:top-[380px] md:left-[600px] size-[12px] md:size-[18px]',
  },
  {
    id: 'pink-blob',
    color: '#D34966',
    className: 'top-[40%] left-[8%] md:top-[380px] md:left-[65px] size-[12px] md:size-[18px]',
  },
  {
    id: 'purple-blob',
    color: '#861F97',
...
export default function HeroConfetti() {
  ...
  return (
    // Changed w-[35%] to w-full and added z-0
    <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none z-0">
      {BLOBS.map((blob, id) => (
        <span
          ...
          // ADDED: backgroundColor style
          style={{ backgroundColor: blob.color }}
          className={cn('absolute rounded-full opacity-90 blur-[0.5px] animated-blob', blob.className)}
        />
      ))}
    </div>
  );
